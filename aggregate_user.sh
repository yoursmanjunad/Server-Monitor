...
# Extract CPU usage sections and summarize
...
# Extract Memory usage sections and summarize
...
# Extract Disk usage sections and summarize
...
# Extract Disk I/O stats sections and summarize
...
# Extract Network usage sections and summarize
...
echo "Cumulative Usage Report created at $OUTPUT_FILE"
